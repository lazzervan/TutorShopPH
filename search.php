			  	...
			  	<form method="post">
			  		<div class="itemrow">
			  			...
			  			<div style="width: 75%; float: left;">
							...
							<input type="text" name="sublist[]" " placeholder="Others, Please Specify" value=""<span></span>
			  			</div>
			  		</div>
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 75%; float: left;" >
				  				<?php echo '<input type="text" style="width: 174px;" name="location" value="'.$f_loca.'" placeholder="e.g: Zamboanga City">'; ?>
				  			</div>
				  		</div>
