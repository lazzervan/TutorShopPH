...
<div>
  ...
  color: #A92A2A;">'.$succs_message.'</div>';
												...
												echo'
											<h2 style="text-align: center;">Update Tutor Informaion</h2>'; ?>
											<div class="itemrow">
									  			<div style="width: 20%; float: left;">
									  				<label>Languages: </label>
									  			</div>
									  			<div style="width: 80%; float: left;">
									  				<div class="divp50"><input <?php $medium1=strstr($medium, "Bangla"); if($medium1 != '') echo 'checked'; ?> type="checkbox" name="medium_list[]" value="Bangla"><span>Tagalog/Filipino</span></div>
											...
											<div class="itemrow">
									  			...
									  			<div style="width: 80%; float: left;">
									  				<div class="divp50"><input <?php $sub1=strstr($sub, "Bangla"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Bangla"><span>Tagalog/Filipino</span></div>
											...
											<div class="itemrow">
									  			...
									  			<div style="width: 80%; float: left;">
									  				...
									  				<div class="divp50"><input <?php $class1=strstr($cls, "One Hour"); if($class1 != '') echo 'checked'; ?> type="checkbox" name="class_list[]" value="One Hour"><span>One Hour</span></div>
													<div class="divp50"><input <?php $class1=strstr($cls, "Two Hours"); if($class1 != '') echo 'checked'; ?> type="checkbox" name="class_list[]" value="Two Hours"><span>Two Hours</span></div>
													<div class="divp50"><input <?php $class1=strstr($cls, "Three Hours"); if($class1 != '') echo 'checked'; ?> type="checkbox" name="class_list[]" value="Three Hours"><span>Three Hours</span></div>
													<div class="divp50"><input <?php $class1=strstr($cls, "Four Hours"); if($class1 != '') echo 'checked'; ?> type="checkbox" name="class_list[]" value="Four Hours"><span>Four Hours</span></div>
													<div class="divp50"><input <?php $class1=strstr($cls, "Five Hours"); if($class1 != '') echo 'checked'; ?> type="checkbox" name="class_list[]" value="Five Hours"><span>Five Hours</span></div>
													<div class="divp50"><input <?php $class1=strstr($cls, "Flexible Hours"); if($class1 != '') echo 'checked'; ?> type="checkbox" name="class_list[]" value="Flexible Hours"><span>Flexible Hours</span></div>
