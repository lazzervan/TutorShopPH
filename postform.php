...
if (isset($_POST['submit'])) {
	...
	try {
		...
		if(empty($_POST['p_university'])) {
			throw new Exception('Please input some details');
...
<div>
	<div>
		...
		<div class="topnav">
		  ...
		  <div class="mask2" href="index.php"><i class="fa fa-home fa-3x"></i></div>
		</div>
			  	...
			  	<form action="#" method="post">
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
				  				<?php echo '<input type="text" name="location" value="'.$f_loca.'" placeholder="e.g: Zamboanga City">'; ?>
				  			</div>
				  		</div>
					<div class="itemrow">
				  			<div style="width: 20%; float: left;">
							  ...
							  <?php if($f_uni!="") echo '<option value="'.$f_uni.'">'.$f_uni.'</option>';  ?>
				  				<?php echo '<input type="text" name="p_university" value="'.$f_uni.'" placeholder="e.g.: I need help on...">'; ?>
				  			</div>
						</div>
					<div class="itemrow">
				  			<div style="width: 20%; float: left;">
				  			...
				  			<div style="width: 20%; float: left;">
				  				<p><?php echo '<input name="deadline" type="text" id="datepicker" placeholder="e.g: 3/10/2022" value="'.$f_dead.'">'; ?></p>
				  			</div>
				  		</div>
